...
<body style="background: #F0FFFF;">
                        ...
                        <div class="container-fluid" style="margin-bottom: 50px;">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <h1 class="display-5" style="border-radius: 10px;color: var(--bs-body-bg);">User's Info</h1>
                                </div>
                            </div>
                            <div class="card" id="TableSorterCard" style="border-style: none;border-radius: 6.5px;">
                                <div class="card-header py-3" style="border-width: 0px;background: rgb(23,25,33);">
                                    <div class="row table-topper align-items-center">
                                        <div class="col-12 col-sm-12 col-md-12 col-xl-12 col-xxl-12 text-end d-xl-flex flex-column align-items-xl-end" style="margin: 0px;padding: 5px 15px;"><input type="search" id="searchInputUser" placeholder="Search" style="margin-right: 10px;" oninput="searchTable('userTable', 'searchInputUser')">
                                            <div class="d-flex justify-content-end justify-content-sm-end justify-content-lg-end table-controls"><button class="btn btn-sm" type="button" style="font-family: 'Work Sans', sans-serif;color: var(--bs-body-bg);border-color: #000000;background: #000000;margin-right: 10px;margin-top: 10px;" onclick="printTable()">Print</button>
                                                <div class="dropdown" style="padding-left: 0px;" data-bs-toggle="dropdown" aria-expanded="false"><button class="btn btn-sm dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" id="filterDropdown" type="button" style="color: #f1f2f1;background: #000000;margin-top: 10px;margin-right: 15px;font-family: 'Work Sans', sans-serif;">Filter</button>
                                                    <div class="dropdown-menu" aria-labelledby="filterDropdown"><a class="dropdown-item" href="#" onclick="sortTable('userTable', 'date')">By Date</a><a class="dropdown-item" href="#" onclick="sortTable('userTable', 'name')">By Name</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="table-responsive" style="border-top-style: none;background: #171921;">
                                            <table class="table table-striped table tablesorter" id="userTable" style="display: block !important; visibility: visible !important;">
                                                <thead class="thead-dark" style="background: rgb(33,37,48);border-width: 0px;border-color: rgb(0,0,0);border-bottom-color: #21252F;">
                                                    <tr style="border-style: none;border-color: rgba(255,255,255,0);background: #21252f;">
                                                        <th class="text-center" style="font-family: 'Work Sans', sans-serif;color: var(--bs-table-striped-color);width: 30%;border-color: var(--bs-table-bg);">Member ID</th>
                                                        <th class="text-center" style="font-family: 'Work Sans', sans-serif;color: var(--bs-table-striped-color);width: 30%;border-color: var(--bs-table-bg);">Name</th>
                                                        <th class="text-center" style="font-family: 'Work Sans', sans-serif;color: var(--bs-table-striped-color);width: 130%;border-color: var(--bs-table-bg);">Contact</th>
                                              ...
                                              <tbody class="text-center" id="memberTableBody">
                                            <script>
                                                fetch("GetMemberServlet")
                                                    .then(response => response.text())
                                                    .then(data => {
                                                        document.getElementById("memberTableBody").innerHTML = data;
                                                    })
    ...
    function searchTable(tableId, searchInputId) {
        ...
        // Loop through the rows and filter based on search query
