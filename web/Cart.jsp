    ...
    <nav class="navbar navbar-expand-md bg-body py-3" style="border-radius: 19px;background: linear-gradient(white, #dff0d8 0%), var(--bs-navbar-brand-color);">
                                                ...
                                                <table class="table table-striped table tablesorter" id="plantTable" style="display: block !important; visibility: visible !important;">
                                                    <thead class="thead-dark" style="background: rgb(33,37,48);border-width: 0px;border-color: rgb(0,0,0);border-bottom-color: #21252F;">
                                                        <tr style="border-style: none;border-color: rgba(255,255,255,0);background: #21252f;">
                                                            ...
                                                            <th class="text-center" style="font-family: 'Work Sans', sans-serif;color: var(--bs-table-striped-color);width: 130%;border-color: var(--bs-table-bg);">Price</th>
       ...
       <script>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2"></script>
